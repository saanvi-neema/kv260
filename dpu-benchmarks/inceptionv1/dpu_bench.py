...
XMODEL_LOCAL = os.path.join(SCRIPT_DIR, "models", "dpu_tf_inceptionv1.xmodel")
...
def run():
    ...
    print("InceptionV1 model loaded!", flush=True)
    ...
    print("="*40)
    print(f"Expected: ~217.7 FPS, ~7.93W, ~27.44 FPS/Watt")
